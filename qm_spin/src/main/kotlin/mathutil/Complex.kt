 ...
 *
 * http://kotlinmath.org/2020/03/03/complex-numbers/
 */
interface Complex {
     ...
     * @param z the summand
     * @return mathutil.sum of this and z
     */
     ...
     * @param x the summand
     * @return mathutil.sum of this and x
     */
        ...
        "NaN" -> NaN
            ...
            when (parts.size) {
                ...
                4 -> complex(
                    ...
                    (parts[2] + parseIm(parts[3])).toDouble()
                )
 ...
 * @return the created complex number
 */
var complex: (re: Number, im: Number) -> Complex = { re, im ->
    DefaultComplex(
        re.toDouble(),
        im.toDouble()
    )
 ...
 */
open class DefaultComplex(override val re: Double, override val im: Double = 0.0) :
    Complex {
